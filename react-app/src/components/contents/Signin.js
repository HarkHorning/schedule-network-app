  ...
  return (
    <header className='contents'>
        <div className='page clear flex justify-center'>
            <section className='w-3/5 z-10 min-w-96 h-4/5 bg-gradient-to-br from-red-300 to-blue-400 flex flex-col justify-center items-center'>
                ...
                <input
                className='placeholder-white text-sm shadow rounded bg-transparent p-2 pl-2 mb-6'
                placeholder='Username'
                ></input>

                <label value=''>Password</label>
                <input
                className='placeholder-white text-sm shadow-md rounded bg-transparent p-2 pl-2 mb-6'
